...
class Entidad_Origen(Base):
	...
	org_nivel_tecnologico = Column(String(20), nullable=True, index=True) 
...
class Entidad_Destino(Base):
	...
	dest_nivel_tecnologico = Column(String(20), nullable=True, index=True) 
...
class Asignacion_Tarea(Base):
	...
	asg_evaluacion = Column(String(15), nullable=True, index=True) #Positiva, Mejorable
	asg_evaluacion_pred = Column(String(15), nullable=True, index=True) #Positiva, Mejorable 
